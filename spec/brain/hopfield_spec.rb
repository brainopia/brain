...
describe Brain::Hopfield do
  ...
  it "learning samples should have a same arity" do
    lambda { Hopfield.new [[2, 2], [1]] }.should raise_error(ArgumentError)
    lambda { Hopfield.new [[2, 2], [2, 2]] }.should_not raise_error
  end
  ...
  describe '(after initialization)' do
    ...
    it "should correctly calculate a weight matrix" do
      net.instance_variable_get(:@weights).should == Matrix[ [ 0, -2, -2],
                                                             [-2,  0, -2],
                                                             [ 2, -2,  0] ]
    end
